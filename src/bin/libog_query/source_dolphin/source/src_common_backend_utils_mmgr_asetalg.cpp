 ...
 * - AlignMemoryAllocator::AllocSetContextCreate
 * - AlignMemoryAllocator::AllocSetContextSetMethods
 * - AlignMemoryAllocator::AllocSetMethodDefinition
 * - AlignMemoryAllocator::AllocSetAlloc
 * - AlignMemoryAllocator::AllocSetFree
 * - AlignMemoryAllocator::AllocSetRealloc
 * - AlignMemoryAllocator::AllocSetInit
 * - AlignMemoryAllocator::AllocSetReset
 * - AlignMemoryAllocator::AllocSetDelete
 * - AlignMemoryAllocator::AllocSetGetChunkSpace
 * - AlignMemoryAllocator::AllocSetIsEmpty
 * - AlignMemoryAllocator::AllocSetStats
 * - AlignMemoryAllocator::AllocSetCheck
 * - AlignMemoryAllocator::AllocSetContextCreate
 *--------------------------------------------------------------------
 */
