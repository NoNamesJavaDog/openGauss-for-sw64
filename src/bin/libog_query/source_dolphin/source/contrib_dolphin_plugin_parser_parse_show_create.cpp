 ...
 * - findCreateProc
 * - makeShowCreateFuncQuery
 * - makeNameString
 * - makeTargetFuncAlias
 * - makeWhereTargetForFunc
 * - makeCurrentSchemaFunc
 * - findCreateClass
 * - makeShowCreateViewQuery
 * - makeShowCreateTableQuery
 * - makeTypeCast
 * - makeStringConstCast
 * - findCreateTrigger
 * - makeShowCreateDatabaseQuery
 *--------------------------------------------------------------------
 */
...
SelectStmt *findCreateTrigger(RangeVar *trel){return nullptr;}
