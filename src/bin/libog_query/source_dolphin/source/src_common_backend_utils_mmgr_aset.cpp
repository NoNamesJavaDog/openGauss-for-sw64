 ...
 * - GenericMemoryAllocator::AllocSetContextCreate
 * - MemoryContextControlSet
 * - built_in_white_list
 * - strcmp_by_wildcards
 * - GenericMemoryAllocator::AllocSetContextSetMethods
 * - GenericMemoryAllocator::AllocSetMethodDefinition
 * - GenericMemoryAllocator::AllocSetAlloc
 * - set_sentinel
 * - PosmagicNum
 * - AllocSetFreeIndex
 * - GenericMemoryAllocator::AllocSetFree
 * - check_pointer_valid
 * - sentinel_ok
 * - GenericMemoryAllocator::AllocSetRealloc
 * - GenericMemoryAllocator::AllocSetInit
 * - GenericMemoryAllocator::AllocSetReset
 * - GenericMemoryAllocator::AllocSetDelete
 * - GenericMemoryAllocator::AllocSetGetChunkSpace
 * - GenericMemoryAllocator::AllocSetIsEmpty
 * - GenericMemoryAllocator::AllocSetStats
 * - GenericMemoryAllocator::AllocSetCheck
 * - MemoryContextControlSet
 * - AllocSetContextCreate
 * - GenericMemoryAllocator::AllocSetContextSetMethods
 * - GenericMemoryAllocator::AllocSetAlloc
