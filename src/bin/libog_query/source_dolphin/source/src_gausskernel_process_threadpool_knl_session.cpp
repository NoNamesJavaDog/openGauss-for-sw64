 ...
 * - u_sess
 * - enable_plpgsql_undefined_not_check_nspoid
 * - enable_plpgsql_gsdependency
 * - set_function_style_pg
 * - set_is_create_plsql_type
 ...
 * - knl_u_erand_init
 * - knl_u_index_init
 * - knl_u_instrument_init
 * - knl_u_locale_init
 * - knl_u_log_init
 * - knl_u_libpq_init
 * - knl_u_mb_init
 * - knl_u_misc_init
 * - knl_u_optimizer_init
 * - knl_u_parser_init
 * - knl_u_pgxc_init
 * - knl_u_plancache_init
 * - knl_u_parameterization_init
 * - knl_u_plpgsql_init
 * - knl_u_xact_init
 * - knl_u_postgres_init
 * - knl_u_proc_init
 ...
 * - knl_u_trigger_init
 * - knl_u_tscache_init
 * - knl_u_typecache_init
 * - knl_u_upgrade_init
 * - knl_u_utils_init
 * - knl_u_security_init
 * - knl_u_wlm_init
 * - knl_u_unique_sql_init
 * - knl_u_user_login_init
 * - knl_u_percentile_init
 * - knl_u_slow_query_init
 * - knl_u_trace_context_init
 * - knl_u_statement_init
 * - knl_u_streaming_init
 * - knl_u_ledger_init
 * - knl_u_libsw_init
 * - KnlURepOriginInit
 * - knl_u_clientConnTime_init
 * - knl_u_opfusion_reuse_init
 * - knl_u_imcstore_init
 * - knl_u_datavec_init
 * - create_session_context
 * - knl_session_init
 * - knl_u_executor_init
 * - alloc_context_from_top
 *--------------------------------------------------------------------
 */
...
static void knl_u_stat_init(knl_u_stat_context* stat_cxt) {return;}
