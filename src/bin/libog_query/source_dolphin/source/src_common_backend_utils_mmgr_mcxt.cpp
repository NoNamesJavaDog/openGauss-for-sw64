 ...
 * - IsTopMemCxt
 * - PreventActionOnSealedContext
 * - RemoveMemoryAllocInfo
 * - CurrentMemoryContext
 * - repallocDebug
 * - MemoryContextCheckMaxSize
 * - MemoryContextCheckSessionMemory
 * - InsertMemoryAllocInfo
 * - repallocHugeDebug
 ...
 * - TopMemCxtUnSeal
 * - MemoryContextUnSeal
 * - RemoveMemoryContextInfo
 * - TopMemCxtSeal
 * - MemoryContextSeal
 * - FreeMemoryContextList
 ...
 */
  ...
  // save the topm of postmaster thread
