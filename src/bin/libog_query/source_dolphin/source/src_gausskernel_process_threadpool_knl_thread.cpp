 ...
 * - KnlDcfContextInit
 * - knl_t_aes_init
 * - knl_t_aiocompleter_init
 * - knl_t_alarmchecker_init
 * - knl_t_arch_init
 * - knl_t_xlogcopybackend_init
 * - knl_t_barrier_arch_init
 * - knl_t_async_init
 * - knl_t_audit_init
 * - knl_t_autovacuum_init
 * - knl_t_basebackup_init
 * - knl_t_bgwriter_init
 * - knl_t_bootstrap_init
 * - knl_t_pagewriter_init
 * - knl_t_barrier_creator_init
 * - knl_t_bulkload_init
 * - knl_t_cbm_init
 * - knl_t_checkpoint_init
 * - knl_t_codegen_init
 * - knl_t_comm_init
 * - knl_t_conn_init
 * - knl_t_contrib_init
 * - knl_t_cstore_init
 * - knl_t_csnmin_sync_init
 * - knl_t_dataqueue_init
 * - knl_t_datarcvwriter_init
 * - knl_t_datareceiver_init
 * - knl_t_datasender_init
 * - knl_t_dfs_init
 * - knl_t_dynahash_init
 * - knl_t_explain_init
 * - knl_t_format_init
 * - knl_t_index_init
 * - knl_t_interrupt_init
 * - knl_t_job_init
 * - knl_t_libwalreceiver_init
 * - knl_t_logger_init
 * - knl_t_logical_init
 * - knl_t_log_init
 * - knl_t_libpq_init
 * - knl_t_lwlockmoniter_init
 * - knl_t_mem_init
 * - knl_t_obs_init
 * - knl_t_pgxc_init
 * - knl_t_port_init
 * - knl_t_postgres_init
 * - knl_t_postmaster_init
 * - knl_t_proc_init
 * - knl_t_relopt_init
 * - knl_t_replgram_init
 * - knl_t_replscanner_init
 * - knl_t_shemem_ptr_init
 * - knl_t_sig_init
 * - knl_t_slot_init
 * - knl_t_snapshot_init
 * - knl_t_startup_init
 ...
 * - knl_t_syncgram_init
 * - knl_t_syncrep_init
 * - knl_t_syncrepscanner_init
 * - knl_t_time_init
 * - knl_t_tsearch_init
 * - knl_t_twophasecleaner_init
 * - knl_t_utils_init
 * - knl_t_vacuum_init
 * - knl_t_walrcvwriter_init
 * - knl_t_walreceiver_init
 * - knl_t_walreceiverfuncs_init
 * - knl_t_walsender_init
 * - knl_t_walwriter_init
 * - knl_t_walwriterauxiliary_init
 * - knl_t_catchup_init
 * - knl_t_wlm_init
 * - knl_t_xact_init
 * - knl_t_xlog_init
 * - knl_t_ash_init
 * - knl_t_statement_init
 * - knl_t_pencentile_init
 * - knl_t_perf_snap_init
 * - knl_t_page_redo_init
 * - knl_t_exrto_recycle_init
 * - knl_t_parallel_decode_init
 * - knl_t_parallel_decode_reader_init
 * - knl_t_heartbeat_init
 * - knl_t_streaming_init
 * - knl_t_poolcleaner_init
 * - knl_t_ts_compaction_init
 * - KnlTUndoInit
 * - KnlTUndolauncherInit
 * - KnlTUndoworkerInit
 * - KnlTUndorecyclerInit
 * - KnlTUstoreInit
 * - KnlTRollbackRequestsInit
 * - knl_t_security_policy_init
 * - knl_t_security_ledger_init
 * - knl_t_bgworker_init
 * - knl_index_advisor_init
 * - knl_t_sql_patch_init
 * - knl_t_dms_context_init
 * - KnlTApplyLauncherInit
 * - KnlTApplyWorkerInit
 * - KnlTPublicationInit
 * - knl_t_imcstore_vacuum_init
 * - knl_t_mot_init
 * - KnlTGstatInit
 * - knl_t_page_compression_init
 * - knl_t_rc_init
 * - knl_t_inval_msg_init
 *--------------------------------------------------------------------
 */
