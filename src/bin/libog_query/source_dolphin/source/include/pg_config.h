...
/* Define to 1 if you want LLVM support. (--enable-llvm).
   Supported only in single_node mode, not supported with (--enable-multiple-nodes) */
#define ENABLE_LLVM_COMPILE 1

/* Define to 1 if you want BBOX support. (--enable-bbox).
   Supported only in single_node mode, not supported with (--enable-multiple-nodes) */
/* #undef ENABLE_BBOX */
...
#define DEF_GS_VERSION "(openGauss 7.0.0-RC1 build ce98d47b) compiled at 2025-03-07 18:31:32 commit 0 last mr  debug"
...
#define PG_VERSION_STR "(openGauss 7.0.0-RC1 build ce98d47b) compiled at 2025-03-07 18:31:32 commit 0 last mr  debug on aarch64-unknown-linux-gnu, compiled by g++ (GCC) 10.3.1, 64-bit"
