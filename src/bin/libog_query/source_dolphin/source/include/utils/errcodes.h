...
#define ERRCODE_BLOB_OFFSET_OVERFLOW MAKE_SQLSTATE('2','2','P','0','7')
...
/* Class 34 - Invalid Condition Number */
...
#define ERRCODE_CREATE_SUBTYPE_UNDER_FINAL MAKE_SQLSTATE('4','2','P','3','0')
#define ERRCODE_MAP_METHOD_PARAMETER MAKE_SQLSTATE('4','2','P','3','1')
#define ERRCODE_OBJECT_ONLY_ONE_MAP_OR_ORDER_METHOD MAKE_SQLSTATE('4','2','P','3','2')
#define ERRCODE_OBJECT_TYPE_METHOD_DEFINE_ERROR MAKE_SQLSTATE('4','2','P','3','3')
#define ERRCODE_OBJECT_TYPE_BODY_DEFINE_ERROR MAKE_SQLSTATE('4','2','P','3','4')
#define ERRCODE_OBJECT_TYPE_STATIC_ERROR MAKE_SQLSTATE('4','2','P','3','4')
...
#define ERRCODE_FDW_TOO_MANY_DDL_CHANGES_IN_TRANSACTION MAKE_SQLSTATE('H','V','0','3','4')
#define ERRCODE_FDW_DROP_INDEXED_COLUMN_NOT_ALLOWED MAKE_SQLSTATE('H','V','0','3','5')
...
/* Class SR - Uncorrected Error & warning */
#define ERRCODE_SR_RECOVERY_CONFLICT MAKE_SQLSTATE('S','R','0','0','1')

/* Class UT - gms_tcp */
#define ERRCODE_END_OF_INPUT MAKE_SQLSTATE('U','0','0','0','1')
#define ERRCODE_NETWORK_ERROR MAKE_SQLSTATE('U','0','0','0','2')
#define ERRCODE_BAD_ARGUMENT MAKE_SQLSTATE('U','0','0','0','3')
#define ERRCODE_TRANSFER_TIMEOUT MAKE_SQLSTATE('U','0','0','0','4')
#define ERRCODE_PARTIAL_MULTIBYTE_CHAR MAKE_SQLSTATE('U','0','0','0','5')
#define ERRCODE_BUFFER_TOO_SMALL MAKE_SQLSTATE('U','0','0','0','6')
