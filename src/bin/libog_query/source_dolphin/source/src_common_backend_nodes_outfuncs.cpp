 ...
 * - _outIndexScan
 * - _outIndexScanInfo
 * - _outCommonIndexScanPart
 * - _outIndexOnlyScan
 * - _outIndexOnlyScanInfo
 * - _outCStoreIndexScan
 * - _outBitmapIndexScan
 * - _outBitmapHeapScan
 * - _outBitmapHeapScanInfo
 * - _outAnnIndexScan
 * - _outAnnIndexScanInfo
 * - _outCStoreIndexCtidScan
 * - _outCStoreIndexHeapScan
 * - _outCStoreIndexAnd
 * - _outCStoreIndexOr
 * - _outTidScan
 * - _outPartIteratorParam
 * - _outPartIterator
 * - _outSubqueryScan
 * - _outFunctionScan
 * - _outValuesScan
 ...
 * - _outWorkTableScan
 * - _outForeignScan
 * - _outCommonForeignScanPart
 * - _outForeignPartState
 * - _outExtensiblePlan
 * - _outJoin
 * - _outJoinPlanInfo
 * - _outNestLoop
 ...
 * - _outRelOptInfo
 * - _outIndexOptInfo
 * - _outDependenciesProchead
 * - _outDependenciesUndefined
 * - _outDependenciesType
 * - _outDependenciesVariable
 ...
 * - _outCreateStmtInfo
 * - _outPartitionState
 * - _outRangePartitionDefState
 * - _outListPartitionDefState
 * - _outHashPartitionDefState
 * - _outIntervalPartitionDefState
 * - _outRangePartitionindexDefState
 * - _outRangePartitionStartEndDefState
 * - _outAddPartitionState
 * - _outAddSubPartitionState
 * - _outCreateForeignTableStmt
 * - _outIndexStmt
 * - _outNotifyStmt
 * - _outDeclareCursorStmt
 * - _outCursorExpression
 * - _outCopyStmt
 * - _outAlterTableStmt
 * - _outAlterTriggerStmt
 * - _outCreateMatViewLogStmt
 * - _outDropMatViewLogStmt
 * - _outSelectStmt
 * - _outMergeStmt
 * - _outInsertStmt
 * - _outUpdateStmt
 ...
 * - _outUpsertClause
 * - _outCommonTableExpr
 * - _outStartWithTargetRelInfo
 * - _outSetOperationStmt
 * - _outRangeTblEntry
 * - _outRteRelation
 * - _outPartitionNameList
 * - _outTableSampleClause
 * - OutTimeCapsuleClause
 * - _outAExpr
 * - _outColumnRef
 * - _outParamRef
 * - _outAConst
 ...
 * - _outKeepClause
 * - _outPruningResult
 * - _outSubPartitionPruningResult
 * - _outDistFdwDataNodeTask
 * - _outDistFdwFileSegment
 * - _outSplitInfo
 * - _outSplitMap
 * - _outErrorCacheEntry
 * - _outDfsPrivateItem
 ...
 * - _outVecMergeJoin
 * - _outVecWindowAgg
 * - _outInformationalConstraint
 * - _outAttrMetaData
 * - _outRelationMetaData
 * - _outForeignOptions
 * - _outBloomFilterSet
 * - _outUint64Array
 * - _outUint16Array
 ...
 * - _outUserSetElem
 * - _outUserVar
 * - _outPLDebug_variable
 * - _outPLDebug_breakPoint
 * - _outPLDebug_frame
 * - _outPLDebug_codeline
 * - _outCharsetcollateOptions
 * - _outCharsetClause
 * - _outShrinkStmt
 * - _outAutoIncrement
 * - _outIndexHintDefinition
 * - _outIndexHintRelationData
 *--------------------------------------------------------------------
 */
