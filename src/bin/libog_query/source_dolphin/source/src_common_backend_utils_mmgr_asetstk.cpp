 ...
 * - StackMemoryAllocator::AllocSetContextCreate
 * - StackMemoryAllocator::AllocSetContextSetMethods
 * - StackMemoryAllocator::AllocSetMethodDefinition
 * - StackMemoryAllocator::AllocSetAlloc
 * - StackMemoryAllocator::AllocSetFree
 * - StackMemoryAllocator::AllocSetRealloc
 * - StackMemoryAllocator::AllocSetInit
 * - StackMemoryAllocator::AllocSetReset
 * - StackMemoryAllocator::AllocSetDelete
 * - StackMemoryAllocator::AllocSetGetChunkSpace
 * - StackMemoryAllocator::AllocSetIsEmpty
 * - StackMemoryAllocator::AllocSetStats
 * - StackMemoryAllocator::AllocSetCheck
 * - StkBlkMagicNum
 *--------------------------------------------------------------------
 */
