 ...
 * - _copyCStoreScan
 * - _copyIMCStoreScan
 * - _copyVecSubqueryScan
 * - _copyVecHashJoin
 * - _copyVecAsofJoin
 * - _copyVecAgg
 * - _copyVecPartIterator
 * - _copyVecAppend
 * - _copyVecSetOp
 * - _copyVecForeignScan
 * - _copyVecModifyTable
 ...
 * - _copyUpsertExpr
 * - _copyPartitionState
 * - _copyRangePartitionDefState
 * - _copyListPartitionDefState
 * - _copyHashPartitionDefState
 * - _copyIntervalPartitionDefState
 * - _copyRangePartitionindexDefState
 * - _copySplitPartitionState
 * - _copyAddPartitionState
 * - _copyAddSubPartitionState
 * - _copyRangePartitionStartEndDefState
 * - _copyMergeAction
 * - _copyPrefixKey
 * - _copyPathKey
 * - _copyRestrictInfo
 ...
 * - _copySelectStmt
 * - _copySelectIntoVarList
 * - _copySetOperationStmt
 * - _copyAlterTableStmt
 * - _copyAlterTriggerStmt
 * - _copyAlterTableCmd
 ...
 * - _copyCreatePackageStmt
 * - _copyCreatePackageBodyStmt
 ...
 * - _copyCreateMatViewLogStmt
 * - _copyDropMatViewLogStmt
 * - _copyReplicaIdentityStmt
 * - _copyAlterSystemStmt
 * - _copyCreateSeqStmt
 * - _copyAlterSeqStmt
 * - _copyVariableSetStmt
 * - _copyVariableMultiSetStmt
 ...
 * - _copyForeignPartState
 * - _copyCreateForeignTableStmt
 * - _copyCreateDataSourceStmt
 * - _copyAlterSchemaStmt
 * - _copyAlterDataSourceStmt
 * - _copyCreateRlsPolicyStmt
 * - _copyAlterRlsPolicyStmt
 * - _copyCreateAmStmt
 * - _copyCreateTrigStmt
 ...
 * - _copyReindexStmt
 * - _copyCreatePolicyLabelStmt
 * - _copyAlterPolicyLabelStmt
 * - _copyDropPolicyLabelStmt
 * - _copyCreateAuditPolicyStmt
 * - _copyAlterAuditPolicyStmt
 * - _copyDropAuditPolicyStmt
 * - _copyCreateMaskingPolicyStmt
 * - _copyAlterMaskingPolicyStmt
 * - _copyDropMaskingPolicyStmt
 * - _copyMaskingPolicyCondition
 * - _copyPolicyFilterNode
 * - _copyCreateWeakPasswordDictionaryStmt
 * - _copyDropWeakPasswordDictionaryStmt
 * - _copyBarrierStmt
 * - _copyAlterNodeStmt
 * - _copyCreateNodeStmt
 * - _copyDropNodeStmt
 * - _copyCreateGroupStmt
 * - _copyAlterGroupStmt
 * - _copyDropGroupStmt
 * - _copyCleanConnStmt
 * - _copyCreateResourcePoolStmt
 * - _copyAlterResourcePoolStmt
 * - _copyDropResourcePoolStmt
 * - _copyAlterGlobalConfigStmt
 * - _copyDropGlobalConfigStmt
 * - _copyCreateWorkloadGroupStmt
 * - _copyAlterWorkloadGroupStmt
 * - _copyDropWorkloadGroupStmt
 * - _copyCreateAppWorkloadGroupMappingStmt
 * - _copyAlterAppWorkloadGroupMappingStmt
 * - _copyDropAppWorkloadGroupMappingStmt
 ...
 * - _copyCreateSynonymStmt
 * - _copyDropSynonymStmt
 * - _copyCreateModelStmt
 * - _copyAExpr
 * - _copyColumnRef
 * - _copyParamRef
 * - _copyAConst
 ...
 * - _copyStartWithTargetRelInfo
 * - _copyStartWithOptions
 * - _copyPosition
 * - _copyPrivGrantee
 * - _copyFuncWithArgs
 * - _copyAccessPriv
 ...
 * - _copyPGXCSubCluster
 * - _copyDistState
 * - _copyListSliceDefState
 * - _copyDistFdwDataNodeTask
 * - _copyDistFdwFileSegment
 * - _copySplitInfo
 * - _copySplitMap
 * - _copyDfsPrivateItem
 * - _copyErrorCacheEntry
 * - _copyInformationalConstraint
 * - _copyGroupingId
 * - _copyBloomFilterSet
 * - _copyAddTblIntoCBIState
 * - _copyAutoIncrement
 * - _copyHintState
 * - _copyJoinHint
 * - CopyBaseHintFilelds
 ...
 * - _copyCopyColExpr
 * - _copyQualSkewInfo
 * - _copyCreateDirectoryStmt
 * - _copyDropDirectoryStmt
 * - _copyPredpushHint
 * - _copyPredpushSameLevelHint
 * - _copyRewriteHint
 * - _copyGatherHint
 * - _copyNoExpandHint
 * - _copySetHint
 ...
 * - _copyUserSetElem
 * - _copyUserVar
 * - _copyPredictByFunctionStmt
 * - _copyDropSubscriptionStmt
 * - _copyPartialPlannerInfo
 * - _copyRelOptInfoArray
 * - _copyRelOptInfo
 * - _copyRangeTblEntryArray
 * - _copyPlannerGlobal
 * - _copyCharsetcollateOptions
 * - _copyPartialIndexOptInfo
 * - node_copy_create_event_info
 * - node_copy_alter_event_info
 * - node_copy_drop_event_info
 * - node_copy_show_event_info
 * - _copyIndexHintRelationData
 * - _copyIndexHintDefinition
 * - _copyFunctionSources
 * - _copyCondInfo
 * - _copyGetDiagStmt
 * - _copyDolphinCallStmt
 * - _copyCharsetClause
 * - _copyShrinkStmt
 *--------------------------------------------------------------------
 */
