...
%type <str> DefineStmt
%type <str> type_body_subprogram
%type <str> Method_specList
%type <str> element_spec
%type <str> final_clause
%type <str> inheritance_clause
%type <str> object_func_args_with_defaults
%type <str> object_proc_args
%type <str> method_decl_in_type_list
%type <str> element_decl_in_type
%type <str> subprogram_decl_in_type
%type <str> constructor_decl_in_type
%type <str> map_order_decl_in_type
...
%type <str> insert_inline_view_target
...
%type <str> rotate_table
%type <str> unrotate_table
...
%type <str> func_expr
%type <str> opt_over_clause
%type <str> analytic_func_expr
%type <str> fromLast
%type <str> ignNulls
%type <str> func_application
%type <str> func_application_special
%type <str> opt_default_fmt_clause
%type <str> opt_default_nls_clause
%type <str> opt_on_error_clause
%type <str> on_error_clause
%type <str> func_with_separator
%type <str> func_expr_windowless
%type <str> func_expr_common_subexpr
%type <str> default_on_err_expr
...
/* orig_tokens */
 ...
 TABLE TABLE_NAME TABLES TABLESAMPLE TABLESPACE TARGET TEMP TEMPLATE TEMPORARY TERMINATED TEXT_P THAN THEN TIME TIME_FORMAT_P TIES TIMECAPSULE TIMESTAMP TIMESTAMP_FORMAT_P TIMESTAMPDIFF TIMEZONE_HOUR_P TIMEZONE_MINUTE_P TINYINT
...
%nonassoc UIDENT GENERATED NULL_P PARTITION SUBPARTITION RANGE ROWS PRECEDING FOLLOWING CUBE ROLLUP
 ...
 %token CONSTRUCTOR FINAL MAP MEMBER RESULT SELF STATIC_P UNDER
 %token SELF_INOUT
 STATIC_FUNCTION
 MEMBER_FUNCTION
 STATIC_PROCEDURE
...
|  ALTER TABLE CONCURRENTLY relation_expr MODIFY_P '(' modify_column_cmds ')'
 { 
 $$ = cat_str(5,mm_strdup("alter table concurrently"),$4,mm_strdup("modify ("),$7,mm_strdup(")"));
}
...
|  ALTER TABLE CONCURRENTLY IF_P EXISTS relation_expr MODIFY_P '(' modify_column_cmds ')'
 { 
 $$ = cat_str(5,mm_strdup("alter table concurrently if exists"),$6,mm_strdup("modify ("),$9,mm_strdup(")"));
}
...
|  ALTER TABLE CONCURRENTLY relation_expr alter_table_or_partition
 { 
 $$ = cat_str(3,mm_strdup("alter table concurrently"),$4,$5);
}
...
|  ALTER TABLE CONCURRENTLY IF_P EXISTS relation_expr alter_table_or_partition
 { 
 $$ = cat_str(3,mm_strdup("alter table concurrently if exists"),$6,$7);
}
...
|  IF_P NOT EXISTS columnDef
 { 
 $$ = cat_str(2,mm_strdup("if not exists"),$4);
}
;
...
;
 ...
 { 
 $$ = cat_str(3,mm_strdup("modify partition"),$2,mm_strdup("imcstored"));
}
|  MODIFY_PARTITION imcs_partition_name IMCSTORED '(' name_list ')'
 { 
 $$ = cat_str(5,mm_strdup("modify partition"),$2,mm_strdup("imcstored ("),$5,mm_strdup(")"));
}
|  MODIFY_PARTITION imcs_partition_name UNIMCSTORED
 { 
 $$ = cat_str(3,mm_strdup("modify partition"),$2,mm_strdup("unimcstored"));
}
;
...
|  ADD_P IF_P NOT EXISTS columnDef add_column_first_after
 { 
 $$ = cat_str(3,mm_strdup("add if not exists"),$5,$6);
}
...
|  ADD_P COLUMN IF_P NOT EXISTS columnDef add_column_first_after
 { 
 $$ = cat_str(3,mm_strdup("add column if not exists"),$6,$7);
}
...
;
 ...
 { 
 $$ = cat_str(2,mm_strdup("create materialized view log on"),$6);
}
;
 ...
 { 
 $$ = cat_str(2,mm_strdup("drop materialized view log on"),$6);
}
;
...
;
 ...
 { 
 $$ = cat_str(7,mm_strdup("create"),$2,$3,mm_strdup("synonym"),$5,mm_strdup("for"),$7);
}
;
 ...
 { 
 $$ = cat_str(5,mm_strdup("drop"),$2,mm_strdup("synonym"),$4,$5);
}
|  DROP opt_public SYNONYM IF_P EXISTS any_name opt_drop_behavior
 { 
 $$ = cat_str(5,mm_strdup("drop"),$2,mm_strdup("synonym if exists"),$6,$7);
}
;
...
;
 ...
 CreateTrigStmt:
 CREATE opt_or_replace definer_user TRIGGER qualified_trigger_name TriggerActionTime TriggerEvents ON qualified_name TriggerForSpec TriggerWhen EXECUTE FUNCTION_or_PROCEDURE func_name '(' TriggerFuncArgs ')'
 { 
 $$ = cat_str(17,mm_strdup("create"),$2,$3,mm_strdup("trigger"),$5,$6,$7,mm_strdup("on"),$9,$10,$11,mm_strdup("execute"),$13,$14,mm_strdup("("),$16,mm_strdup(")"));
}
|  CREATE CONSTRAINT TRIGGER qualified_trigger_name AFTER TriggerEvents ON qualified_name OptConstrFromTable ConstraintAttributeSpec FOR EACH ROW TriggerWhen EXECUTE FUNCTION_or_PROCEDURE func_name '(' TriggerFuncArgs ')'
 { 
...
;
 ...
 CreateEventTrigStmt:
 CREATE EVENT_TRIGGER name ON ColLabel EXECUTE FUNCTION_or_PROCEDURE func_name '(' ')'
 { 
 $$ = cat_str(8,mm_strdup("create event_trigger"),$3,mm_strdup("on"),$5,mm_strdup("execute"),$7,$8,mm_strdup("( )"));
}
|  CREATE EVENT_TRIGGER name ON ColLabel WHEN event_trigger_when_list EXECUTE FUNCTION_or_PROCEDURE func_name '(' ')'
 { 
 $$ = cat_str(10,mm_strdup("create event_trigger"),$3,mm_strdup("on"),$5,mm_strdup("when"),$7,mm_strdup("execute"),$9,$10,mm_strdup("( )"));
}
;
...
|  CREATE TYPE_P any_name as_is OBJECT_P '(' OptTableFuncElementList ')' final_clause
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(7,mm_strdup("create type"),$3,$4,mm_strdup("object ("),$7,mm_strdup(")"),$9);
}
|  CREATE OR REPLACE TYPE_P any_name as_is OBJECT_P '(' OptTableFuncElementList ')' final_clause
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(7,mm_strdup("create or replace type"),$5,$6,mm_strdup("object ("),$9,mm_strdup(")"),$11);
}
|  CREATE TYPE_P any_name as_is OBJECT_P '(' TableFuncElementList ',' Method_specList ')' final_clause
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(9,mm_strdup("create type"),$3,$4,mm_strdup("object ("),$7,mm_strdup(","),$9,mm_strdup(")"),$11);
}
|  CREATE OR REPLACE TYPE_P any_name as_is OBJECT_P '(' TableFuncElementList ',' Method_specList ')' final_clause
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(9,mm_strdup("create or replace type"),$5,$6,mm_strdup("object ("),$9,mm_strdup(","),$11,mm_strdup(")"),$13);
}
|  CREATE TYPE_P any_name UNDER any_name '(' TableFuncElementList ')' final_clause
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(8,mm_strdup("create type"),$3,mm_strdup("under"),$5,mm_strdup("("),$7,mm_strdup(")"),$9);
}
|  CREATE OR REPLACE TYPE_P any_name UNDER any_name '(' TableFuncElementList ')' final_clause
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(8,mm_strdup("create or replace type"),$5,mm_strdup("under"),$7,mm_strdup("("),$9,mm_strdup(")"),$11);
}
|  CREATE TYPE_P any_name UNDER any_name '(' TableFuncElementList ',' Method_specList ')' final_clause
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(10,mm_strdup("create type"),$3,mm_strdup("under"),$5,mm_strdup("("),$7,mm_strdup(","),$9,mm_strdup(")"),$11);
}
|  CREATE OR REPLACE TYPE_P any_name UNDER any_name '(' TableFuncElementList ',' Method_specList ')' final_clause
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(10,mm_strdup("create or replace type"),$5,mm_strdup("under"),$7,mm_strdup("("),$9,mm_strdup(","),$11,mm_strdup(")"),$13);
}
|  CREATE TYPE_P BODY_P any_name as_is type_body_subprogram
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(4,mm_strdup("create type body"),$4,$5,$6);
}
|  CREATE OR REPLACE TYPE_P BODY_P any_name as_is type_body_subprogram
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(4,mm_strdup("create or replace type body"),$6,$7,$8);
}
|  CREATE TYPE_P any_name as_is VARRAY '(' ICONST ')' OF func_type
 { 
 $$ = cat_str(5,mm_strdup("create type"),$3,$4,mm_strdup("varray ( iconst ) of"),$10);
}
|  CREATE OR REPLACE TYPE_P any_name as_is VARRAY '(' ICONST ')' OF func_type
 { 
 $$ = cat_str(5,mm_strdup("create or replace type"),$5,$6,mm_strdup("varray ( iconst ) of"),$12);
}
...
;
 ...
 type_body_subprogram:
 method_decl_in_type_list ';' END_P ';'
 { 
 $$ = cat_str(2,$1,mm_strdup("; end ;"));
}
|  method_decl_in_type_list ';' END_P END_OF_INPUT_COLON
 { 
 $$ = cat_str(2,$1,mm_strdup("; end end_of_input_colon"));
}
;
...
;
 ...
 element_spec:
 inheritance_clause MEMBER_FUNCTION func_name_opt_arg object_proc_args RETURN func_return
 { 
 $$ = cat_str(6,$1,mm_strdup("member_function"),$3,$4,mm_strdup("return"),$6);
}
|  inheritance_clause STATIC_FUNCTION func_name_opt_arg object_proc_args RETURN func_return
 { 
 $$ = cat_str(6,$1,mm_strdup("static_function"),$3,$4,mm_strdup("return"),$6);
}
|  inheritance_clause MEMBER_PROCEDURE func_name_opt_arg object_proc_args
 { 
 $$ = cat_str(4,$1,mm_strdup("memberrocedure"),$3,$4);
}
|  inheritance_clause STATIC_PROCEDURE func_name_opt_arg proc_args
 { 
 $$ = cat_str(4,$1,mm_strdup("staticrocedure"),$3,$4);
}
|  inheritance_clause CONSTRUCTOR_FUNCTION func_name_opt_arg object_proc_args RETURN SELF AS RESULT
 { 
 $$ = cat_str(5,$1,mm_strdup("constructor_function"),$3,$4,mm_strdup("return self as result"));
}
|  inheritance_clause MAP_MEMBER FUNCTION func_name_opt_arg object_proc_args RETURN func_return
 { 
 $$ = cat_str(6,$1,mm_strdup("map_member function"),$4,$5,mm_strdup("return"),$7);
}
|  inheritance_clause MAP_MEMBER PROCEDURE func_name_opt_arg object_proc_args
 { 
 $$ = cat_str(4,$1,mm_strdup("map_member procedure"),$4,$5);
}
|  inheritance_clause ORDER MEMBER_PROCEDURE func_name_opt_arg object_proc_args
 { 
 $$ = cat_str(4,$1,mm_strdup("order memberrocedure"),$4,$5);
}
|  inheritance_clause ORDER MEMBER_FUNCTION func_name_opt_arg object_proc_args RETURN func_return final_clause:
 FINAL
 { 
 $$ = mm_strdup("final");
}
...
;
 ...
 object_func_args_with_defaults:
 '(' SELF_INOUT func_type ',' func_args_with_defaults_list ')'
 { 
 $$ = cat_str(5,mm_strdup("( self_inout"),$3,mm_strdup(","),$5,mm_strdup(")"));
}
...
;
 ...
 element_decl_in_type
 { 
 $$ = $1;
}
|  method_decl_in_type_list ';' element_decl_in_type
 { 
 $$ = cat_str(3,$1,mm_strdup(";"),$3);
}
;
...
;
 ...
 subprogram_decl_in_type:
 inheritance_clause MEMBER_FUNCTION func_name_opt_arg object_proc_args RETURN func_return opt_createproc_opt_list as_is subprogram_body
 { 
 $$ = cat_str(9,$1,mm_strdup("member_function"),$3,$4,mm_strdup("return"),$6,$7,$8,$9);
}
|  inheritance_clause STATIC_FUNCTION func_name_opt_arg object_proc_args RETURN func_return opt_createproc_opt_list as_is subprogram_body
 { 
 $$ = cat_str(9,$1,mm_strdup("static_function"),$3,$4,mm_strdup("return"),$6,$7,$8,$9);
}
|  inheritance_clause MEMBER_PROCEDURE func_name_opt_arg object_proc_args opt_createproc_opt_list as_is subprogram_body
 { 
 $$ = cat_str(7,$1,mm_strdup("memberrocedure"),$3,$4,$5,$6,$7);
}
|  inheritance_clause STATIC_PROCEDURE func_name_opt_arg object_proc_args opt_createproc_opt_list as_is subprogram_body
 { 
 $$ = cat_str(7,$1,mm_strdup("staticrocedure"),$3,$4,$5,$6,$7);
}
;


 constructor_decl_in_type:
 inheritance_clause CONSTRUCTOR_FUNCTION func_name_opt_arg object_proc_args RETURN SELF AS RESULT opt_createproc_opt_list as_is subprogram_body
 { 
 $$ = cat_str(8,$1,mm_strdup("constructor_function"),$3,$4,mm_strdup("return self as result"),$9,$10,$11);
}
;


 map_order_decl_in_type:
 inheritance_clause MAP_MEMBER FUNCTION func_name_opt_arg object_proc_args RETURN func_return opt_createproc_opt_list as_is subprogram_body
 { 
 $$ = cat_str(9,$1,mm_strdup("map_member function"),$4,$5,mm_strdup("return"),$7,$8,$9,$10);
}
|  inheritance_clause MAP_MEMBER PROCEDURE func_name_opt_arg object_proc_args opt_createproc_opt_list as_is subprogram_body
 { 
 $$ = cat_str(7,$1,mm_strdup("map_member procedure"),$4,$5,$6,$7,$8);
}
|  inheritance_clause ORDER MEMBER_FUNCTION func_name_opt_arg object_proc_args RETURN func_return opt_createproc_opt_list as_is subprogram_body
 { 
 $$ = cat_str(9,$1,mm_strdup("order member_function"),$4,$5,mm_strdup("return"),$7,$8,$9,$10);
}
|  inheritance_clause ORDER MEMBER_PROCEDURE func_name_opt_arg object_proc_args opt_createproc_opt_list as_is subprogram_body
 { 
 $$ = cat_str(7,$1,mm_strdup("order memberrocedure"),$4,$5,$6,$7,$8);
}
;
...
|  DROP MATERIALIZED VIEW IF_P EXISTS any_name_list opt_drop_behavior
 { 
 $$ = cat_str(3,mm_strdup("drop materialized view if exists"),$6,$7);
}
|  DROP MATERIALIZED VIEW any_name_list opt_drop_behavior
 { 
 $$ = cat_str(3,mm_strdup("drop materialized view"),$4,$5);
}
...
|  CREATE ecpg_ident SYNONYM
 { 
 $$ = cat_str(3,mm_strdup("create"),$2,mm_strdup("synonym"));
}
|  DROP ecpg_ident SYNONYM
 { 
 $$ = cat_str(3,mm_strdup("drop"),$2,mm_strdup("synonym"));
}
|  CREATE ANY TRIGGER
 { 
...
|  CREATE opt_or_replace definer_user PROCEDURE func_name_opt_arg proc_args LANGUAGE ColId_or_Sconst AS func_as opt_createproc_opt_list
 { 
 $$ = cat_str(11,mm_strdup("create"),$2,$3,mm_strdup("procedure"),$5,$6,mm_strdup("language"),$8,mm_strdup("as"),$10,$11);
}
;
...
|  RESULT_CACHE
 { 
 $$ = mm_strdup("result_cache");
}
|  NOT RESULT_CACHE
 { 
 $$ = mm_strdup("not result_cache");
}
;
...
|  ALTER TRIGGER qualified_trigger_name ON qualified_name OWNER TO RoleId
 { 
 $$ = cat_str(6,mm_strdup("alter trigger"),$3,mm_strdup("on"),$5,mm_strdup("owner to"),$8);
}
;
...
;
 ...
 ClusterStmt:
 CLUSTER opt_verbose opt_concurrently qualified_name cluster_index_specification
 { 
 $$ = cat_str(5,mm_strdup("cluster"),$2,$3,$4,$5);
}
|  CLUSTER opt_verbose opt_concurrently qualified_name PARTITION '(' name ')' cluster_index_specification
 { 
 $$ = cat_str(8,mm_strdup("cluster"),$2,$3,$4,mm_strdup("partition ("),$7,mm_strdup(")"),$9);
}
|  CLUSTER opt_verbose
 { 
 $$ = cat_str(2,mm_strdup("cluster"),$2);
}
|  CLUSTER opt_verbose opt_concurrently index_name ON qualified_name
 { 
 $$ = cat_str(6,mm_strdup("cluster"),$2,$3,$4,mm_strdup("on"),$6);
}
;
...
|  VACUUM opt_full opt_freeze opt_verbose opt_compact opt_concurrently
 { 
 $$ = cat_str(6,mm_strdup("vacuum"),$2,$3,$4,$5,$6);
}
|  VACUUM opt_full opt_freeze opt_verbose opt_compact opt_concurrently qualified_name
 { 
 $$ = cat_str(7,mm_strdup("vacuum"),$2,$3,$4,$5,$6,$7);
}
|  VACUUM opt_full opt_freeze opt_verbose opt_compact opt_concurrently qualified_name PARTITION '('name')'
 { 
 $$ = cat_str(8,mm_strdup("vacuum"),$2,$3,$4,$5,$6,$7,mm_strdup("partition (name)"));
}
|  VACUUM opt_full opt_freeze opt_verbose opt_compact opt_concurrently qualified_name SUBPARTITION '('name')'
 { 
 $$ = cat_str(8,mm_strdup("vacuum"),$2,$3,$4,$5,$6,$7,mm_strdup("subpartition (name)"));
}
|  VACUUM opt_full opt_freeze opt_verbose opt_compact opt_concurrently AnalyzeStmt
 { 
 $$ = cat_str(7,mm_strdup("vacuum"),$2,$3,$4,$5,$6,$7);
}
...
|  analyze_keyword opt_verbose qualified_name opt_name_list SUBPARTITION '('name')'
 { 
 $$ = cat_str(5,$1,$2,$3,$4,mm_strdup("subpartition (name)"));
}
...
|  '(' select_no_parens check_option ')'
 { 
 $$ = cat_str(4,mm_strdup("("),$2,$3,mm_strdup(")"));
}
...
|  FETCH first_or_next opt_select_fetch_first_value opt_percent row_or_rows only_or_ties
 { 
 $$ = cat_str(6,mm_strdup("fetch"),$2,$3,$4,$5,$6);
}
;
...
|  LATERAL_EXPR func_table opt_ordinality alias_clause
 { 
 $$ = cat_str(4,mm_strdup("lateral_expr"),$2,$3,$4);
}
...
|  func_table WITH_ORDINALITY %prec UMINUS
 { 
 $$ = cat_str(2,$1,mm_strdup("with ordinality"));
}
...
|  func_table WITH_ORDINALITY alias_clause
 { 
 $$ = cat_str(3,$1,mm_strdup("with ordinality"),$3);
}
...
|  func_table WITH_ORDINALITY AS '(' TableFuncElementList ')'
 { 
 $$ = cat_str(4,$1,mm_strdup("with ordinality as ("),$5,mm_strdup(")"));
}
...
|  func_table WITH_ORDINALITY AS ColId '(' TableFuncElementList ')'
 { 
 $$ = cat_str(6,$1,mm_strdup("with ordinality as"),$4,mm_strdup("("),$6,mm_strdup(")"));
}
...
|  func_table WITH_ORDINALITY ColId '(' TableFuncElementList ')'
 { 
 $$ = cat_str(6,$1,mm_strdup("with ordinality"),$3,mm_strdup("("),$5,mm_strdup(")"));
}
...
;
 ...
 rotate_table:
 inline_view opt_alias_clause rotate_clause
 { 
 $$ = cat_str(3,$1,$2,$3);
}
...
|  table_ref ASOF_P JOIN table_ref join_qual
 { 
 $$ = cat_str(4,$1,mm_strdup("asof join"),$4,$5);
}
...
|  table_ref CROSS APPLY table_ref
 { 
 $$ = cat_str(3,$1,mm_strdup("cross apply"),$4);
}
|  table_ref OUTER_P APPLY table_ref
 { 
 $$ = cat_str(3,$1,mm_strdup("outer apply"),$4);
}
;
...
|  XMLTABLE '(' XMLNAMESPACES '(' xml_namespace_list ')' ',' c_expr xmlexists_argument COLUMNS xmltable_column_list ')' %prec COLUMNS
 { 
...
;
 ...
 func_expr:
 func_application within_group_clause filter_clause keep_clause opt_over_clause
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(5,$1,$2,$3,$4,$5);
}
...
;
 ...
 { 
 $$ = cat_str(6,mm_strdup("nth_value ("),$3,mm_strdup(")"),$5,$6,$7);
}
|  NTH_VALUE_P '(' func_arg_list ')' fromLast over_clause
 { 
 $$ = cat_str(5,mm_strdup("nth_value ("),$3,mm_strdup(")"),$5,$6);
}
...
|  NTH_VALUE_P '(' func_arg_list ')' over_clause
 { 
 $$ = cat_str(4,mm_strdup("nth_value ("),$3,mm_strdup(")"),$5);
}
;
...
;
 ...
 IGNORE NULLS_P
 { 
 $$ = mm_strdup("ignore nulls");
}
|  RESPECT_P NULLS_P
 { 
 $$ = mm_strdup("respect nulls");
}
;
...
|  func_name '(' func_arg_list DEFAULT func_arg_expr ON CONVERSION_P ERROR_P ')'
 { 
 $$ = cat_str(6,$1,mm_strdup("("),$3,mm_strdup("default"),$5,mm_strdup("on conversion error )"));
}
...
|  func_name '(' func_arg_list DEFAULT func_arg_expr ON CONVERSION_P ERROR_P opt_default_fmt_clause opt_default_nls_clause ')'
 { 
 $$ = cat_str(9,$1,mm_strdup("("),$3,mm_strdup("default"),$5,mm_strdup("on conversion error"),$9,$10,mm_strdup(")"));
}
...
|  JSON_EXISTS '(' func_arg_list opt_on_error_clause ')'
 { 
 $$ = cat_str(4,mm_strdup("json_exists ("),$3,$4,mm_strdup(")"));
}
;
...
;
 ...
 ERROR_ON_ERROR
 { 
 $$ = mm_strdup("error_on_error");
}
|  TRUE_ON_ERROR
 { 
 $$ = mm_strdup("true_on_error");
}
|  FALSE_ON_ERROR
 { 
 $$ = mm_strdup("false_on_error");
}
;
...
|  CAST '(' a_expr AS Typename opt_default_fmt_clause')'
 { 
 $$ = cat_str(5,mm_strdup("cast ("),$3,mm_strdup("as"),$5,mm_strdup("opt_default_fmt_clause)"));
}
|  CAST '(' a_expr AS Typename opt_default_fmt_clause opt_default_nls_clause ')'
 { 
 $$ = cat_str(7,mm_strdup("cast ("),$3,mm_strdup("as"),$5,$6,$7,mm_strdup(")"));
}
...
|  CAST '(' a_expr AS Typename default_on_err_expr opt_default_fmt_clause opt_default_nls_clause ')'
 { 
 $$ = cat_str(8,mm_strdup("cast ("),$3,mm_strdup("as"),$5,$6,$7,$8,mm_strdup(")"));
}
|  CAST '(' a_expr AS Typename default_on_err_expr ')'
 { 
 $$ = cat_str(6,mm_strdup("cast ("),$3,mm_strdup("as"),$5,$6,mm_strdup(")"));
}
...
;
 ...
 { 
 $$ = cat_str(3,mm_strdup("default"),$2,mm_strdup("on conversion error"));
}
;
...
;
 ...
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(3,mm_strdup("keep ( dense_rank first"),$5,mm_strdup(")"));
}
|  KEEP '(' DENSE_RANK LAST_P sort_clause ')'
 { 
mmerror(PARSE_ERROR, ET_WARNING, "unsupported feature will be passed to server");
 $$ = cat_str(3,mm_strdup("keep ( dense_rank last"),$5,mm_strdup(")"));
}
| 
 { 
 $$=EMPTY; }
...
|  TIMEZONE_HOUR_P
 { 
 $$ = mm_strdup("timezone_hour");
}
|  TIMEZONE_MINUTE_P
 { 
 $$ = mm_strdup("timezone_minute");
}
|  ecpg_sconst
 { 
 $$ = $1;
...
|  IMCSTORED '(' name_list ')'
 { 
 $$ = cat_str(3,mm_strdup("imcstored ("),$3,mm_strdup(")"));
}
|  IMCSTORED WITH SHARE_MEMORY
 { 
 $$ = mm_strdup("imcstored with share_memory");
}
|  IMCSTORED '(' name_list ')' WITH SHARE_MEMORY
 { 
 $$ = cat_str(3,mm_strdup("imcstored ("),$3,mm_strdup(") with share_memory"));
}
|  UNIMCSTORED
 { 
 $$ = mm_strdup("unimcstored");
}
;
